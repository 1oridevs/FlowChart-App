...
const EventNode = memo(({ data, selected }: NodeProps) => {
  return (
    <div className={`px-6 py-4 shadow-xl rounded-2xl bg-gradient-to-br from-red-500 via-red-600 to-red-700 text-white border-2 border-red-800 min-w-[180px] max-w-[220px] transition-all duration-300 group ${
