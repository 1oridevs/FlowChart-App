...
const DatabaseNode = memo(({ data, selected }: NodeProps) => {
  return (
    <div className={`px-6 py-4 shadow-xl rounded-2xl bg-gradient-to-br from-green-500 via-green-600 to-green-700 text-white border-2 border-green-800 min-w-[160px] max-w-[200px] transition-all duration-300 group ${
